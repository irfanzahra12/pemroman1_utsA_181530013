...
<!-- 
    Keterangan  :
    if(@$_GET['page'] == "soal-uts"){
        jika sebuah variabel atau parameter dengan nama page bernilai soal uts, maka akan menjalankan perintah 

    include "view/soal-uts.php";
        menyisipkan file soal-uts.php yang berada dalam folder view
